...
|---|---|---|---|---|---|
| T-01 | Start the project with the recommended setup choices | Lines 84–99 | The create-and-configure recipe, including the choices for TypeScript, ESLint, Tailwind, App Router, and Turbopack | [[07 - DEVELOPMENT ROADMAP#Phase 1 — Foundations and the shape of the data\|R-01]] | 🔵 |
| T-02 | Install the helper packages the plan names, plus the icon set from its stack list | Lines 69–105 | Zod, Dexie with its React helpers, react-markdown, remark-gfm, and Lucide React | [[07 - DEVELOPMENT ROADMAP#Phase 1 — Foundations and the shape of the data\|R-01]] | ✅ |
| T-03 | Switch on the ready-made interface kit | Lines 107–111 | The shadcn/ui setup step | [[07 - DEVELOPMENT ROADMAP#Phase 1 — Foundations and the shape of the data\|R-01]] | 🔵 |
| T-04 | Build the sidebar and page frame | Lines 1167–1173, 1271–1275 | The desktop layout of sidebar plus split panes; build-order step 02 | [[07 - DEVELOPMENT ROADMAP#Phase 1 — Foundations and the shape of the data\|R-02]] | ✅ |
...
| T-27 | Enter the eighteen starter presets in four groups | Lines 706–745 | The development, writing, research, and design lists | [[07 - DEVELOPMENT ROADMAP#Phase 4 — The workspace people use\|R-14]] | ⭕ |
...
Every task above serves a roadmap item.
